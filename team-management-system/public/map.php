...
/* این صفحه موقتاً در دست توسعه است. برای فعال‌کردن نسخه کامل، مقدار زیر را false کنید. */
const MAP_UNDER_DEVELOPMENT = true;
if (MAP_UNDER_DEVELOPMENT) {
    require __DIR__ . '/../app/partials/header.php'; ?>
<section class="page-head"><div><h1>حوزه استحفاظی</h1></div></section>
<div class="panel under-dev">
  <div class="under-dev-art" aria-hidden="true">
    <svg viewBox="0 0 96 96" width="96" height="96">
      <defs>
        <clipPath id="udGlass"><path d="M36.5 28h23v5c0 5.5-4.6 9.4-9 14.2v1.6c4.4 4.8 9 8.7 9 14.2v5h-23v-5c0-5.5 4.6-9.4 9-14.2v-1.6c-4.4-4.8-9-8.7-9-14.2z"/></clipPath>
      </defs>
      <circle cx="48" cy="48" r="46" fill="#eef5f1"/>
      <g class="ud-glass">
        <g clip-path="url(#udGlass)">
          <rect class="ud-sand-top" x="35" y="31" width="26" height="16" fill="#6f9a83"/>
          <rect class="ud-stream" x="47.1" y="46" width="1.8" height="23" fill="#6f9a83"/>
          <rect class="ud-sand-bottom" x="35" y="55" width="26" height="14" fill="#6f9a83"/>
        </g>
        <path d="M35 27h26v6c0 6-5 10-9.5 15C56 53 61 57 61 63v6H35v-6c0-6 5-10 9.5-15C40 43 35 39 35 33z" fill="none" stroke="#244b3b" stroke-width="3" stroke-linejoin="round"/>
        <rect x="30" y="22" width="36" height="5" rx="2.5" fill="#244b3b"/>
        <rect x="30" y="69" width="36" height="5" rx="2.5" fill="#244b3b"/>
      </g>
    </svg>
  </div>
  <strong>این صفحه در دست توسعه است</strong>
  <div class="under-dev-bar" aria-hidden="true"><span></span></div>
  <a class="btn secondary under-dev-btn" href="dashboard.php">بازگشت به داشبورد</a>
</div>
...
<div class="panel zone-panel">
  <?php if(!$schemaReady): ?>
    <div class="personnel-empty"><strong>جدول حوزه استحفاظی ساخته نشده است.</strong></div>
