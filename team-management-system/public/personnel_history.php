...
if ($people) {
    ...
    /* ۲) همه نسخه‌های ذخیره‌شده این عناصر، با همان ستون‌هایی که صفحه «مشاهده تغییرات» می‌خواند */
    $hq = $pdo->prepare(
...
<form class="history-filters" method="get">
  <input type="search" name="q" value="<?=e($q)?>" placeholder="نام، نام‌خانوادگی، کد ملی، شماره تلفن" autocomplete="off">
...
<div class="panel history-list-panel">
  ...
  <?php else: ?><div class="personnel-empty"><strong>سابقه‌ای ثبت نشده است.</strong></div><?php endif; ?>
</div>
<style>
