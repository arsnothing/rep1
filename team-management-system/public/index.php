...
?><!doctype html><html lang="fa" dir="rtl"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>ورود</title><link rel="stylesheet" href="<?= e($config['app']['base_url']) ?>/assets/style.css"><script>(function(){try{var t=localStorage.getItem('tms-theme');if(t==='dark'||t==='light')document.documentElement.setAttribute('data-theme',t);}catch(e){}})();</script><link rel="stylesheet" href="<?= e(asset_url('assets/theme.css')) ?>"></head><body class="login-page">
